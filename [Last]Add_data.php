...
<link href="form-validation.css" rel="stylesheet">
    ...
    Dremio Space Name: <input type="text" class="form-control" name="dremio_space_name" required><br>
    Package URL: <input type="text" class="form-control" name="package_url" required><br>
    API key: <input type="text" class="form-control" name="api_key" required><br>
    Import Type:
    ...
    <br>
    File Name: <input type="text" class="form-control" name="file_name" required><br>
    <hr class="my-4">
    ...
    <div class="col-md-6">
        Name: <input type="text" class="form-control" name="resource_name" required><br>
    </div>
    Description: <textarea class="form-control" name="description" required></textarea><br><br>
    <hr class="my-4">
    <input type="submit" class="btn btn-success" name="api_send" value="SEND" required><br>
</form>
        </div>
    </div>
</div>

...
<link href="form-validation.css" rel="stylesheet">
  ...
  <div class="container">
    ...
    Dremio Space Name: <input type="text" class="form-control" name="dremio_space_name" value="<?php echo isset($dremio_space_name)?$dremio_space_name:$_dremio_space_name; ?>" required><br><br>
    Package URL: <input type="text" class="form-control" name="package_url" value="<?php echo isset($package_url)?$package_url:$_package_url; ?>" required><br><br>
    API key: <input type="text" class="form-control" name="api_key"value="<?php echo isset($api_key)?$api_key:$_api_key; ?>" required><br><br>
    Import Type:
    ...
    <br><br>
    File Name: <input type="text" class="form-control" name="file_name" value="<?php echo isset($file_name)?$file_name:$_file_name; ?>" required><br><br>
    Resource Meta<br><br>
    ...
    Name: <input type="text" class="form-control" name="resource_name" value="<?php echo isset($resource_name)?$resource_name:$_resource_name; ?>" required><br><br>
    Description: <textarea class="form-control" name="description" required><?php echo isset($description)?$description:$_description; ?></textarea><br><br>
    <input type="submit" class="btn btn-success" value="UPDATE" name="api_update" required><br><br>
